...
export class Types1577322484950 implements MigrationInterface {
    name = 'Types1577322484950'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `ItemTypeBuffer` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `maxCount` int NOT NULL, `itemTypeId` int NULL, `itemRarityId` int NULL, `currentVersionId` int NULL, UNIQUE INDEX `REL_2802c4f959e4a849cbd33f504b` (`currentVersionId`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `ItemType` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `maxCount` int NOT NULL, `itemTypeId` int NULL, `itemRarityId` int NULL, `updateBufferId` int NULL, UNIQUE INDEX `REL_3843943da1fcce996f93f5ee12` (`updateBufferId`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("ALTER TABLE `ItemTypeBuffer` ADD CONSTRAINT `FK_4a331872363cd310e19d873541c` FOREIGN KEY (`itemTypeId`) REFERENCES `ItemsType`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `ItemTypeBuffer` ADD CONSTRAINT `FK_b22a492cc7d2aa5f0231016b961` FOREIGN KEY (`itemRarityId`) REFERENCES `ItemsRarity`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION", undefined);
        ...
        await queryRunner.query("ALTER TABLE `ItemType` ADD CONSTRAINT `FK_5b01dd11473affd0eb09762c70e` FOREIGN KEY (`itemTypeId`) REFERENCES `ItemsType`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `ItemType` ADD CONSTRAINT `FK_febc1f0489be881b7ba07696b58` FOREIGN KEY (`itemRarityId`) REFERENCES `ItemsRarity`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `ItemType` DROP FOREIGN KEY `FK_febc1f0489be881b7ba07696b58`", undefined);
        ...
        await queryRunner.query("ALTER TABLE `ItemTypeBuffer` DROP FOREIGN KEY `FK_b22a492cc7d2aa5f0231016b961`", undefined);
