...
export class Types1576886566953 implements MigrationInterface {
    name = 'Types1576886566953'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("CREATE TABLE `BuildingType` (`id` int NOT NULL AUTO_INCREMENT, `type` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("CREATE TABLE `CarriageTypes` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `appearenceVersion` varchar(255) NOT NULL, `storageCapacity` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `ItemsType` (`id` int NOT NULL AUTO_INCREMENT, `type` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `ItemTypeBuffer` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `appearenceVersion` varchar(255) NOT NULL, `maxCount` int NOT NULL, `itemTypeId` int NULL, `currentVersionId` int NULL, UNIQUE INDEX `REL_2802c4f959e4a849cbd33f504b` (`currentVersionId`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `ItemType` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `appearenceVersion` varchar(255) NOT NULL, `maxCount` int NOT NULL, `itemTypeId` int NULL, `updateBufferId` int NULL, UNIQUE INDEX `REL_3843943da1fcce996f93f5ee12` (`updateBufferId`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("CREATE TABLE `LocomotiveTypeBuffer` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `appearenceVersion` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `LocomotiveTypes` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `appearenceVersion` varchar(255) NOT NULL, `inRotation` tinyint NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("ALTER TABLE `ItemTypeBuffer` ADD CONSTRAINT `FK_4a331872363cd310e19d873541c` FOREIGN KEY (`itemTypeId`) REFERENCES `ItemsType`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `ItemTypeBuffer` ADD CONSTRAINT `FK_2802c4f959e4a849cbd33f504b7` FOREIGN KEY (`currentVersionId`) REFERENCES `ItemType`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `ItemType` ADD CONSTRAINT `FK_5b01dd11473affd0eb09762c70e` FOREIGN KEY (`itemTypeId`) REFERENCES `ItemsType`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `ItemType` ADD CONSTRAINT `FK_3843943da1fcce996f93f5ee12e` FOREIGN KEY (`updateBufferId`) REFERENCES `ItemTypeBuffer`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        ...
        await queryRunner.query("ALTER TABLE `LocomotivesUpgrades` ADD CONSTRAINT `FK_d4813fcb0178d7a72fd69414957` FOREIGN KEY (`itemId`) REFERENCES `ItemType`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `LocomotivesUpgrades` ADD CONSTRAINT `FK_b9f7b0bcabe8c3ba5174ba8d3f8` FOREIGN KEY (`locomotiveTypeId`) REFERENCES `LocomotiveTypes`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `LocomotiveTypeUpgradeBuffer` ADD CONSTRAINT `FK_c343138e54d5b24dff964d96bdb` FOREIGN KEY (`itemId`) REFERENCES `ItemType`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `LocomotiveTypeUpgradeBuffer` ADD CONSTRAINT `FK_43dc1bdffe417ed83981a3487e2` FOREIGN KEY (`locomotiveTypeId`) REFERENCES `LocomotiveTypeBuffer`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `ItemType` DROP FOREIGN KEY `FK_5b01dd11473affd0eb09762c70e`", undefined);
        await queryRunner.query("ALTER TABLE `ItemTypeBuffer` DROP FOREIGN KEY `FK_2802c4f959e4a849cbd33f504b7`", undefined);
        await queryRunner.query("ALTER TABLE `ItemTypeBuffer` DROP FOREIGN KEY `FK_4a331872363cd310e19d873541c`", undefined);
