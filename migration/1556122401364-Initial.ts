...
export class Initial1556122401364 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "Locomotives" ("id" SERIAL NOT NULL, "level" integer NOT NULL DEFAULT 1, "typeId" integer, "userId" integer, CONSTRAINT "REL_406d0ac2b2eda37620c5df1bc3" UNIQUE ("typeId"), CONSTRAINT "PK_8284bd9b851a8ac240d870ec250" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Carriages" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "userId" integer, "typeId" integer, CONSTRAINT "REL_524edd860f03c64e98095fb04c" UNIQUE ("typeId"), CONSTRAINT "PK_8976644812933b44cd4d77e45ed" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Characters" ADD CONSTRAINT "FK_8b9bb5e9c0e5c4b5b4871efca4d" FOREIGN KEY ("typeId") REFERENCES "CharacterSpecializations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
