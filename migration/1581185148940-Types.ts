...
export class Types1581185148940 implements MigrationInterface {
    name = 'Types1581185148940'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `LocomotiveTypeUpgradeBuffer` (`id` int NOT NULL AUTO_INCREMENT, `count` int NOT NULL, `level` int NOT NULL, `itemId` int NULL, `locomotiveTypeId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `LocomotiveTypeBuffer` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `currentVersionId` int NULL, UNIQUE INDEX `REL_7c5e2afb0433b4463653036677` (`currentVersionId`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `LocomotiveTypes` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `inRotation` tinyint NOT NULL, `updateBufferId` int NULL, UNIQUE INDEX `REL_4040deeee7fd80b5e07a8b525c` (`updateBufferId`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `LocomotivesUpgrades` (`id` int NOT NULL AUTO_INCREMENT, `count` int NOT NULL, `level` int NOT NULL, `itemId` int NULL, `locomotiveTypeId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("ALTER TABLE `LocomotiveTypeBuffer` ADD CONSTRAINT `FK_7c5e2afb0433b4463653036677b` FOREIGN KEY (`currentVersionId`) REFERENCES `LocomotiveTypes`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `LocomotiveTypes` ADD CONSTRAINT `FK_4040deeee7fd80b5e07a8b525c5` FOREIGN KEY (`updateBufferId`) REFERENCES `LocomotiveTypeBuffer`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION", undefined);
        ...
        await queryRunner.query("INSERT INTO `decay_station_db`.`administator` (`id`, `login`, `password`) VALUES ('1', 'Test', '$2y$12$MwiC5f2EJoO7LKFFzw82S.G0InfLWS7F01bkgkjXDb98PoZq2F9xC');", undefined);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `LocomotiveTypes` DROP FOREIGN KEY `FK_4040deeee7fd80b5e07a8b525c5`", undefined);
        await queryRunner.query("ALTER TABLE `LocomotiveTypeBuffer` DROP FOREIGN KEY `FK_7c5e2afb0433b4463653036677b`", undefined);
        ...
        await queryRunner.query("DROP INDEX `REL_4040deeee7fd80b5e07a8b525c` ON `LocomotiveTypes`", undefined);
        await queryRunner.query("DROP TABLE `LocomotiveTypes`", undefined);
        await queryRunner.query("DROP INDEX `REL_7c5e2afb0433b4463653036677` ON `LocomotiveTypeBuffer`", undefined);
